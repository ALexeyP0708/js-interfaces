...
export class InterfaceManager {
     ...
     */
    static validatePropsObject(object,rules){
        let descs=this.getProtoDescriptors(object);
        return this.validateDescriptors(descs, rules);
    }
    ...
    static validatePropsClass(ProtoClass, rules = {protoProps: {}, staticProps: {}}) {
        ...
        let staticErrorsStack = this.validatePropsObject(ProtoClass, rules.staticProps);
