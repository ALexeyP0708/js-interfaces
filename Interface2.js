...
*      }
     ...
     */
    static addRules(ProtoClass,rules={protoProps:{},staticProps:{}}){
     ...
     */
    static extendsInterfaces(ProtoClass,...RestInterfaces){
     ...
     * @param {class[]} RestInterfaces . If the first element of the array is "true" (boolean type), then apply extendClassFromOwnPrototypes before final assembly of ProtoClass
     */
    static implementsInterfaces (ProtoClass,...RestInterfaces){
        ...
        let rules=this.extendsInterfaces(ProtoClass,...RestInterfaces);
